...
class ExpenseType(models.Model):
    class Meta:
        constraints = [CheckConstraint(check=(Q(is_private=False)&Q(tab__isnull=True)|(Q(is_private=True)&Q(tab__isnull=False))), name='is_private_no_tab')]
...
class Associating(models.Model):
    ...
    def __str__(self):
        return f'{self.expense} - {self.user} - {self.id}'
